...
const ContasAnuncioInsightsLog = () => {
  const { id } = useParams();
  ...
  const contasAnunciosData: IInsightsLogData[] = useMemo(() => {
    return (
  ...
  const columns = useMemo<ColumnDef<IInsightsLogData>[]>(
    () => [
      {
        accessorKey: 'id',
  ...
  const Toolbar = () => {
    ...
    return (
      <div className="card-header flex-wrap px-5 py-4 border-b-0">
        <h3 className="card-title">Historico de Transações</h3>
...
export { ContasAnuncioInsightsLog };

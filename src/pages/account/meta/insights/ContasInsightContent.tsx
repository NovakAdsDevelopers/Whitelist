...
import { ContasAnuncioInsightsLog } from './blocks';
import { DailySpendInsightsLog } from './blocks/dailySpends';

const ContasAnuncioInsightsContent = () => {
  return (
    <div className="grid gap-5 lg:gap-7.5">
      <div className="w-full grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg border bg-card text-card-foreground shadow-info border-none drop-shadow-sm">
          <div className="space-y-1.5 p-6 pb-0 flex flex-row items-center justify-between gap-x-4">
      ...
      <ContasAnuncioInsightsLog />

      <DailySpendInsightsLog />
...
export { ContasAnuncioInsightsContent };
